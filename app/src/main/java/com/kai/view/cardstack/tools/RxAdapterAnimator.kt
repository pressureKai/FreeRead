 ...
 */
abstract class RxAdapterAnimator(public var mRxCardStackView: RxCardStackView) {
    @JvmField
    ...
    protected abstract fun itemExpandAnimatorSet(
        viewHolder: RxCardStackView.ViewHolder?,
        position: Int
    )
        ...
        mSet!!.addListener(object : AnimatorListenerAdapter() {
            override fun onAnimationStart(animation: Animator) {
                ...
                preSelectViewHolder?.onAnimationStateChange(
                    RxCardStackView.ANIMATION_STATE_START,
                    false
                )
            ...
            override fun onAnimationEnd(animation: Animator) {
                ...
                preSelectViewHolder?.onAnimationStateChange(
                    RxCardStackView.ANIMATION_STATE_END,
                    false
                )
            ...
            override fun onAnimationCancel(animation: Animator) {
                ...
                preSelectViewHolder?.onAnimationStateChange(
                    RxCardStackView.ANIMATION_STATE_CANCEL,
                    false
                )
